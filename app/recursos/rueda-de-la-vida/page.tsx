...
export const metadata: Metadata = {
  title: "Rueda de la Vida | Johana Ríos",
  description: "Herramienta interactiva de reflexión personal. Evaluá 8 áreas clave de tu vida y descubrí dónde estás hoy y dónde te gustaría estar.",
}
      ...
      <main className="min-h-screen bg-background pt-16 lg:pt-20">
        ...
        <section className="py-12 lg:py-16 bg-gradient-to-b from-secondary/30 to-background">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-foreground text-balance leading-tight">
                Rueda de la Vida
              </h1>
            </div>
        ...
        <section className="py-10 lg:py-16 bg-primary/5">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-semibold text-foreground text-center mb-6 text-balance">
